...
import { Button, Input, Select, StatCard, SectionHeader, Badge, Spinner, ErrorBox } from '../components/UI'
...
function pct(v) {
  ...
  return <span style={{ color: v >= 0 ? 'var(--green)' : 'var(--red)' }}>{v >= 0 ? '+' : ''}{n}%</span>
}
...
export default function Chart() {
  ...
  useEffect(() => {
    ...
    // Sync timescales
    function syncHandler(range) { macdChart.timeScale().setVisibleLogicalRange(range) }
